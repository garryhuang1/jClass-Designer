package jcf.controller;

import jcf.ui.AppYesNoCancelDialogSingleton;
import jcf.ui.AppMessageDialogSingleton;
...
import static jcf.settings.AppPropertyType.LOAD_ERROR_MESSAGE;
import static jcf.settings.AppPropertyType.LOAD_ERROR_TITLE;
import static jcf.settings.AppPropertyType.LOAD_WORK_TITLE;
import static jcf.settings.AppPropertyType.WORK_FILE_EXT;
import static jcf.settings.AppPropertyType.WORK_FILE_EXT_DESC;
import static jcf.settings.AppPropertyType.NEW_COMPLETED_MESSAGE;
import static jcf.settings.AppPropertyType.NEW_COMPLETED_TITLE;
import static jcf.settings.AppPropertyType.NEW_ERROR_MESSAGE;
import static jcf.settings.AppPropertyType.NEW_ERROR_TITLE;
import static jcf.settings.AppPropertyType.SAVE_COMPLETED_MESSAGE;
import static jcf.settings.AppPropertyType.SAVE_COMPLETED_TITLE;
import static jcf.settings.AppPropertyType.SAVE_ERROR_MESSAGE;
import static jcf.settings.AppPropertyType.SAVE_ERROR_TITLE;
import static jcf.settings.AppPropertyType.SAVE_UNSAVED_WORK_MESSAGE;
import static jcf.settings.AppPropertyType.SAVE_UNSAVED_WORK_TITLE;
import static jcf.settings.AppPropertyType.SAVE_WORK_TITLE;
import static jcf.settings.AppStartupConstants.PATH_WORK;
