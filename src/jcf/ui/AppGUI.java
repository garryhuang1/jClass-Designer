...
public class AppGUI implements AppStyleArbiter {
    ...
    protected Button screenshotButton;
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        exportCodeButton = initChildButton(exportSnapshot, EXPORT_CODE_ICON.toString(), EXPORT_CODE_TOOLTIP.toString(), false);
        screenshotButton = initChildButton(exportSnapshot, SCREENSHOT_ICON.toString(), SCREENSHOT_TOOLTIP.toString(), false);
        
        fileToolbarPane.getChildren().add(exportSnapshot);
