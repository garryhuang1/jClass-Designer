...
public class TestTwo {
    ...
    public void checkVar1(){
        ...
        assertEquals("app", testList.get(3).getVariables().get(0).getName());
    }
    @Test
    public void checkVar2(){
        System.out.println("* Check variable type 1");
        assertEquals("ThreadExample", testList.get(3).getVariables().get(0).getType());
    }
    @Test
    public void checkMet1(){
        System.out.println("* Check Method Name 1");
        assertEquals("DateTask", testList.get(3).getMethods().get(0).getName());
    }
    @Test
    public void checkMet2(){
        System.out.println("* Check method argument");
        int end = testList.get(3).getMethods().get(0).getArg().toString().length();
        assertEquals("ThreadExample", testList.get(3).getMethods().get(0).getArg().toString().substring(1, end-1));
    }
    @Test
    public void checkPoint1(){
        System.out.println("* Check point 1");
        Point2D a = new Point2D(575, 0);
        assertEquals(a, testList.get(3).getPoint().get(0));
    }
    @Test
    public void checkPoint2(){
        System.out.println("* Check point 2");
        Point2D a = new Point2D(575, 300);
        assertEquals(a, testList.get(3).getPoint().get(1));
    }
    @Test
    public void checkPoint3(){
        System.out.println("* Check point 3");
        Point2D a = new Point2D(250, 0);
        assertEquals(a, testList.get(3).getPoint().get(2));
    }
    @Ignore
    @Test
